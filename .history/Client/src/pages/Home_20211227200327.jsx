...
const Home = () => {
  ...
  const [showTravelerRegistration, handleshowTravelerRegistration] =
    useState(false);
  const [showRegistrationOrLogin, handleShowRegistrationOrLogin] = useState(true)
  ...
  return (
    <div className="home-container">
      ...
      <div className="home-top-container">
        ...
        {!showRegistrationOrLogin && <Acountmodallogin fields={driverLoginFields} title="התחברות כנהג"/>}
      </div>
